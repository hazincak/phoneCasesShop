        ...
        <div class="container">
            ...
            <div class="row">
                <div class="card col-lg-3 text-center">
                    <i class="fas fa-check-circle icon card__icon"></i>
                    <h3>Easy to order.</h3>
                ...
                <div class="card col-lg-3 text-center">
                    <i class="fas fa-undo card__icon"></i>
                    <h3>Customer can send or return goods</h3>
                ...
                <div class="card col-lg-3 text-center">
                    <i class="fas fa-warehouse card__icon"></i>
                    <h3>All covers on store</h3>
                ...
                <div class="card col-lg-3 text-center">
                    <i class="fas fa-dolly card__icon"></i>
